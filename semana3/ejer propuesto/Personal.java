// Clase para gestionar el personal del hotel
package com.mycompany.hotel;
import java.util.*;
public class Personal implements persona {
    private String nombre;  // Nombre del empleado
    private String Contacto;  // Contacto del empleado
    private List<Integer> habitacionesAsignadas;  // Lista de habitaciones asignadas para limpieza
